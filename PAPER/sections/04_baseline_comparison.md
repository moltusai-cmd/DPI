...
| Milestone (Step) | Xavier (Random) | Kaiming (Standard) | T-Fixup (Zero-Out) | **DPI (DPI-14)** |
| :--- | :--- | :--- | :--- | :--- |
...
**Conclusion on Baselines**: The empirical evidence indicates that DPI provides strong performance compared to both variance-preserving noise (Xavier/Kaiming) and identity-based scaling (T-Fixup). By instantiating a pre-conditioned latent manifold, DPI allows the optimization process to bypass initial stochastic misalignment and proceed directly to semantic refinement.
