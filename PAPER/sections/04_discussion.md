...
### 4.10.1 Experimental Protocol: BF16 vs. NF4
...
### 4.10.2 Results: Persistence of Structural Priors
...
### 4.10.3 Analysis of Signal Excitation
...
### 4.10.4 Synthesis of Computational Accessibility
The fact that a 1.1B model in 4-bit precision achieves a loss of **8.07** in just 50 steps—surpassing stochastic baselines in native precision—proves that DPI is an ideal candidate for **democratized LLM training**. It allows researchers to trade precision for memory efficiency without losing the structural priors required for stable convergence.
