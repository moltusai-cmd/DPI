...
def get_scheduler(optimizer, total_steps):
    # 10% Warm-up, 40% Plateau, 50% Cosine Decay
...
def train():
    ...
    print("Starting PID-8.1 (Fertile Soil) Initialization...")
    ...
    model.train()
    print(f"\nStarting {epochs} Epochs Training ({total_steps} total steps)...")
    ...
    # Save the fertile model
    torch.save(model.state_dict(), "pid8_fertile_4epochs.pt")
    print("Model saved to pid8_fertile_4epochs.pt")
