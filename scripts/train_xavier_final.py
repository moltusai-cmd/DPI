...
def train():
    ...
    log_file = open("loss_xavier.csv", "w", newline="")
    ...
    for epoch in range(epochs):
        for x, y in loader:
            ...
            if global_step % 100 == 0:
                print(f"Xavier | Epoch {epoch+1} | Step {global_step} | Loss: {loss.item():.4f}")
                
    torch.save(model.state_dict(), "model_xavier_final.pt")
    log_file.close()
